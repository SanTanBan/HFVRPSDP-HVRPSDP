...
def ATSAMT_6_JF(directory_details_for_saving="",directory_containing_Vehicle_Types_file="",directory_containing_Node_Locations_file="",directory_containing_Distance_Matrix_file="",Time_Constraint=99999999999999999999999999999999999999999999999):

    dir_name="ATSAML_6_JF Evaluation"
    os.mkdir(directory_details_for_saving+dir_name)
    directory_to_save_ATSAMT_6_JF_solution=directory_details_for_saving+dir_name+"/"
    ...
    def Decoding_Mechanism_0(Node_Sequence):
        ...
        if x_b[0]>Optimal_Cost:
            mu_of_a_b_c_d_e_f[0]+=(aa-mu_of_a_b_c_d_e_f[0])*pow((1-pow(100,-3*f/f_iter)+pow(f/f_iter,1/15))/2,0.5)
            mu_of_a_b_c_d_e_f[1]+=(bb-mu_of_a_b_c_d_e_f[1])*pow((1-pow(100,-3*f/f_iter)+pow(f/f_iter,1/15))/2,0.5)
            mu_of_a_b_c_d_e_f[2]+=(cc-mu_of_a_b_c_d_e_f[2])*pow((1-pow(100,-3*f/f_iter)+pow(f/f_iter,1/15))/2,0.5)
            mu_of_a_b_c_d_e_f[3]+=(dd-mu_of_a_b_c_d_e_f[3])*pow((1-pow(100,-3*f/f_iter)+pow(f/f_iter,1/15))/2,0.5)
            mu_of_a_b_c_d_e_f[4]+=(ee-mu_of_a_b_c_d_e_f[4])*pow((1-pow(100,-3*f/f_iter)+pow(f/f_iter,1/15))/2,0.5)
            mu_of_a_b_c_d_e_f[5]+=(ff-mu_of_a_b_c_d_e_f[5])*pow((1-pow(100,-3*f/f_iter)+pow(f/f_iter,1/15))/2,0.5)

            sigma_of_a_b_c_d_e_f[0]*=(1+sigma_direction[0]*(f-random())/(f_iter+random()))/(1-sigma_direction[0]*(f-random())/(f_iter+random()))
            sigma_of_a_b_c_d_e_f[1]*=(1+sigma_direction[1]*(f-random())/(f_iter+random()))/(1-sigma_direction[1]*(f-random())/(f_iter+random()))
            sigma_of_a_b_c_d_e_f[2]*=(1+sigma_direction[2]*(f-random())/(f_iter+random()))/(1-sigma_direction[2]*(f-random())/(f_iter+random()))
            sigma_of_a_b_c_d_e_f[3]*=(1+sigma_direction[3]*(f-random())/(f_iter+random()))/(1-sigma_direction[3]*(f-random())/(f_iter+random()))
            sigma_of_a_b_c_d_e_f[4]*=(1+sigma_direction[4]*(f-random())/(f_iter+random()))/(1-sigma_direction[4]*(f-random())/(f_iter+random()))
            sigma_of_a_b_c_d_e_f[5]*=(1+sigma_direction[5]*(f-random())/(f_iter+random()))/(1-sigma_direction[5]*(f-random())/(f_iter+random()))
    ...
    print(" Starting ATSAMT_6_JF following Evaluation Processes after reading Inputs")
    ...
    textfile = open(directory_to_save_ATSAMT_6_JF_solution+"Vehicle Routes from ATSAMT_6_JF.txt","w")
    ...
    #while (f<f_iter or slope>min_slope) and delta_T<=Time_Constraint:
        ...
        if x_dash[0]<=t*x_b[0]:
            ...
            if x[0]<x_b[0]:
                ...
                if sigma_of_a_b_c_d_e_f[0]<1e-9:
                    sigma_direction[0]=+1
                elif sigma_of_a_b_c_d_e_f[0]>1e0:
                    sigma_direction[0]=-1
                if sigma_of_a_b_c_d_e_f[1]<1e-9:
                    sigma_direction[1]=+1
                elif sigma_of_a_b_c_d_e_f[1]>1e0:
                    sigma_direction[1]=-1
                if sigma_of_a_b_c_d_e_f[2]<1e-9:
                    sigma_direction[2]=+1
                elif sigma_of_a_b_c_d_e_f[2]>1e0:
                    sigma_direction[2]=-1
                if sigma_of_a_b_c_d_e_f[3]<1e-9:
                    sigma_direction[3]=+1
                elif sigma_of_a_b_c_d_e_f[3]>1e0:
                    sigma_direction[3]=-1
                if sigma_of_a_b_c_d_e_f[4]<1e-9:
                    sigma_direction[4]=+1
                elif sigma_of_a_b_c_d_e_f[4]>1e0:
                    sigma_direction[4]=-1
                if sigma_of_a_b_c_d_e_f[5]<1e-9:
                    sigma_direction[5]=+1
                elif sigma_of_a_b_c_d_e_f[5]>1e0:
                    sigma_direction[5]=-1   
    ...
    for k in Vehicle_Types:
        ...
        main_dir_for_Image=directory_to_save_ATSAMT_6_JF_solution+"{}"
    ...
    textfile0 = open(directory_to_save_ATSAMT_6_JF_solution+"Time_Plot.txt","w")
    textfile0.write(str(Time_Plot))
    textfile0.close()

    textfile1 = open(directory_to_save_ATSAMT_6_JF_solution+"Objective_Plot.txt","w")
    textfile1.write(str(Objective_Plot))
    textfile1.close()

    textfile2 = open(directory_to_save_ATSAMT_6_JF_solution+"Time_Plot_fr_f.txt","w")
    textfile2.write(str(Time_Plot_fr_f))
    textfile2.close()

    textfile3 = open(directory_to_save_ATSAMT_6_JF_solution+"f_Plot.txt","w")
    textfile3.write(str(f_Plot))
    textfile3.close()
    
    textfile4 = open(directory_to_save_ATSAMT_6_JF_solution+"ALL_tIME.txt","w")
    textfile4.write(str(ALL_tIME))
    textfile4.close()

    textfile5 = open(directory_to_save_ATSAMT_6_JF_solution+"Threshold.txt","w")
    textfile5.write(str(Threshold))
    textfile5.close()

    textfile6 = open(directory_to_save_ATSAMT_6_JF_solution+"Times_for_Objectives_above_Threshold.txt","w")
    textfile6.write(str(Times_for_Objectives_above_Threshold))
    textfile6.close()

    textfile7 = open(directory_to_save_ATSAMT_6_JF_solution+"Objectives_above_Threshold.txt","w")
    textfile7.write(str(Objectives_above_Threshold))
    textfile7.close()

    textfile8 = open(directory_to_save_ATSAMT_6_JF_solution+"Times_for_Objectives_below_Threshold.txt","w")
    textfile8.write(str(Times_for_Objectives_below_Threshold))
    textfile8.close()


    textfile9 = open(directory_to_save_ATSAMT_6_JF_solution+"Objectives_below_Threshold.txt","w")
    textfile9.write(str(Objectives_below_Threshold))
    textfile9.close()

    textfile10 = open(directory_to_save_ATSAMT_6_JF_solution+"set_of_mu_of_a_2_f.txt","w")
