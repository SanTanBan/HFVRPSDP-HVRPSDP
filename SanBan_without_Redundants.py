...
def SANBAN_withoutRedundant_Algorithm(max_seconds_allowed_for_calculation=86400,directory_containing_Node_Specifications_file="",directory__containing_Vehicle_Specifications_file="",directory_containing_Distance_Matrices_file="",directory_details_for_saving=""):
    
    os.mkdir(directory_details_for_saving+"SanBan_without_Redundants")
    directory_to_save_Gurobi_solution=directory_details_for_saving+"SanBan_without_Redundants/"
