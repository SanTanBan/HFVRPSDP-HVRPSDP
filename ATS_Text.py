...
def ATS_Text(directory_details_for_saving="",directory_containing_Vehicle_Types_file="",directory_containing_Node_Locations_file="",directory_containing_Distance_Matrix_file=""):

    os.mkdir(directory_details_for_saving+"ATS Text Solution")
    directory_to_save_ATS_solution=directory_details_for_saving+"ATS Text Solution/"
    ...
    def Decoding_Mechanism(Node_Sequence):
        ...
        # The Solution is represented as set of only those X(i,j,k)==1, where i to j is the traversed From and To Nodes by a Vehicle Type K
    ...
    textfile = open(directory_to_save_ATS_solution+"Vehicle Routes from ATS Heuristic of Paper.txt","w")
