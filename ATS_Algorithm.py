...
def ATS_Algorithm(directory_details_for_saving="",directory_containing_Vehicle_Types_file="",directory_containing_Node_Locations_file="",directory_containing_Distance_Matrix_file=""):

    os.mkdir(directory_details_for_saving+"ATS Algorithm Solution")
    directory_to_save_ATS_solution=directory_details_for_saving+"ATS Algorithm Solution/"
